...
import { slate, gray, green, amber, yellow, sky, red } from './colors';

export const theme = {
  // Primary theme - used for main actions and highlights
  primary: {
    main: slate[900], // Deep slate - strong & modern
    hover: slate[800], // Slightly lighter slate for hover
    light: slate[100] // Subtle slate tint for backgrounds
  },
