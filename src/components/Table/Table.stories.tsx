...
const userColumns: TableColumn<User>[] = [
  ...
  },
  {
    ...
    render: (value: User['status']) => {
      ...
      return <Badge variant={variantMap[value]} size="small">{value}</Badge>;
    },
  },
  {
    key: 'role',
...
const productColumns: TableColumn<Product>[] = [
  ...
  },
  {
    ...
    title: 'Featured',
    align: 'center',
    render: (value: boolean) => value ? <Badge variant="primary" size="small">Featured</Badge> : null,
  },
  {
    key: 'actions',
    title: 'Actions',
        ...
        <div style={{ marginBottom: '16px', padding: '12px', backgroundColor: '#f8f9fa', borderRadius: '6px' }}>
          ...
          {selectedKeys.length > 0 && (
            <div style={{ marginTop: '8px', fontSize: '14px' }}>
              Selected IDs: {selectedKeys.join(', ')}
            </div>
          )}
        </div>
      ...
      <div>
        <div style={{ 
          ...
          <div>
            ...
            <p style={{ margin: 0, color: '#666', fontSize: '14px' }}>
              Manage your users with sorting, selection, and bulk actions
            </p>
          </div>
        ...
        {selectedKeys.length > 0 && (
          <div style={{ 
            ...
            <strong>{selectedKeys.length}</strong> row(s) selected. 
