...
describe('Badge Component', () => {
  ...
  it('has proper accessibility attributes for dot style', () => {
    render(<Badge style="dot" variant="success">Status</Badge>);
  ...
  it('renders filled primary badge correctly', () => {
    render(<Badge variant="primary" style="filled">Primary</Badge>);
  ...
  it('renders outlined secondary badge correctly', () => {
    render(<Badge variant="secondary" style="outlined">Secondary</Badge>);
  ...
  it('renders large success badge correctly', () => {
    render(<Badge variant="success" size="large">Success</Badge>);
  ...
  it('renders small danger badge correctly', () => {
    render(<Badge variant="danger" size="small">Error</Badge>);
