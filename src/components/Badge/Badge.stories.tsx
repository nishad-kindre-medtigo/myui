...
export const Circular: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
      <Badge circular variant="danger" size="small">3</Badge>
      <Badge circular variant="primary">12</Badge>
      <Badge circular variant="success" size="large">99</Badge>
    </div>
  ),
  parameters: {
    docs: {
...
export const MaxValue: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
      <Badge circular variant="danger" max={9}>5</Badge>
      <Badge circular variant="danger" max={9}>12</Badge>
      <Badge circular variant="danger" max={99}>150</Badge>
      <Badge circular variant="danger" max={999}>1500</Badge>
    </div>
  ),
  parameters: {
    docs: {
...
export const ZeroHandling: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
        <Badge circular variant="danger" showZero={false}>0</Badge>
        <span style={{ fontSize: '12px', color: '#666' }}>showZero: false</span>
        <span style={{ fontSize: '11px', color: '#999' }}>(hidden)</span>
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
        <Badge circular variant="danger" showZero={true}>0</Badge>
...
export const NotificationBadges: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '30px', alignItems: 'center' }}>
      ...
      <div style={{ position: 'relative', display: 'inline-block' }}>
        <Button variant="outlined" icon={<span>📧</span>}>Email</Button>
        <Badge 
          style="dot"
          variant="success"
          size="small"
...
export const ContentVariations: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
      ...
      <Badge variant="danger" circular>!</Badge>
    </div>
  ),
  parameters: {
    docs: {
